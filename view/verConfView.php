...
?>
                                        <tr>
                                            ...
                                            <td width="30%" align=center>
                                                <a href="../controller/confController.php?action=edit&directorio=<?=$directoriosConf[$i]?>"><img src="../img/edit.png" alt="" width="7%"></a>
                                            </td>
                                            <td width="30%" align=center>
<?php
			...
			<div class="white-bg">
				<div class="container">
					<div class="section-top-border text-center">
						Añadir nuevo directorio <a href="../controller/confController.php?action=create"><img src="../img/add.png" alt="" width="3%"></a>
					</div>
				</div>
			</div>
			<!-- End text Area -->
